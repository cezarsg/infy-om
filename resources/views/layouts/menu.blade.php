...
<li class="{{ Request::is('anuncioabrangenciaatuacaos*') ? 'active' : '' }}">
    <a href="{!! route('anuncioabrangenciaatuacaos.index') !!}"><i class="fa fa-edit"></i><span>Anuncioabrangenciaatuacaos</span></a>
</li>

<li class="{{ Request::is('anuncioavaliacaos*') ? 'active' : '' }}">
    <a href="{!! route('anuncioavaliacaos.index') !!}"><i class="fa fa-edit"></i><span>Anuncioavaliacaos</span></a>
</li>
...
<li class="{{ Request::is('anuncianteRamoNegocios*') ? 'active' : '' }}">
    <a href="{!! route('anuncianteRamoNegocios.index') !!}"><i class="fa fa-edit"></i><span>Anunciante Ramo Negocios</span></a>
</li>
...
<li class="{{ Request::is('tipoEventoRamoNegocios*') ? 'active' : '' }}">
    <a href="{!! route('tipoEventoRamoNegocios.index') !!}"><i class="fa fa-edit"></i><span>Tipo Evento Ramo Negocios</span></a>
</li>
