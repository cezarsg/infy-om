...
<li class="{{ Request::is('anuncianteDiaPromocoes*') ? 'active' : '' }}">
    <a href="{!! route('anuncianteDiaPromocoes.index') !!}"><i class="fa fa-edit"></i><span>Anunciante Dia Promoções</span></a>
</li>

<li class="{{ Request::is('anunciantehistoricos*') ? 'active' : '' }}">
    <a href="{!! route('anunciantehistoricos.index') !!}"><i class="fa fa-edit"></i><span>Anunciante Históricos</span></a>
</li>
...
<li class="{{ Request::is('anuncios*') ? 'active' : '' }}">
    <a href="{!! route('anuncios.index') !!}"><i class="fa fa-edit"></i><span>Anúncio</span></a>
</li>

<li class="{{ Request::is('anuncioAbrangenciaAtuacaos*') ? 'active' : '' }}">
    <a href="{!! route('anuncioAbrangenciaAtuacaos.index') !!}"><i class="fa fa-edit"></i><span>Anúncio Abrangência Atuação</span></a>
</li>

<li class="{{ Request::is('anuncioAvaliacaos*') ? 'active' : '' }}">
    <a href="{!! route('anuncioAvaliacaos.index') !!}"><i class="fa fa-edit"></i><span>Anúncio Avaliações</span></a>
</li>

<li class="{{ Request::is('anuncioDiaPromocoes*') ? 'active' : '' }}">
    <a href="{!! route('anuncioDiaPromocoes.index') !!}"><i class="fa fa-edit"></i><span>Anúncio Dia Promoções</span></a>
</li>

<li class="{{ Request::is('anuncioFotos*') ? 'active' : '' }}">
    <a href="{!! route('anuncioFotos.index') !!}"><i class="fa fa-edit"></i><span>Anúncio Fotos</span></a>
</li>

<li class="{{ Request::is('anuncioHorarioAtendimentos*') ? 'active' : '' }}">
    <a href="{!! route('anuncioHorarioAtendimentos.index') !!}"><i class="fa fa-edit"></i><span>Anúncio Horário Atendimentos</span></a>
</li>

<li class="{{ Request::is('anuncioPrecoMedioEventos*') ? 'active' : '' }}">
    <a href="{!! route('anuncioPrecoMedioEventos.index') !!}"><i class="fa fa-edit"></i><span>Anúncio Preço Médio Eventos</span></a>
</li>

<li class="{{ Request::is('anuncioPremios*') ? 'active' : '' }}">
    <a href="{!! route('anuncioPremios.index') !!}"><i class="fa fa-edit"></i><span>Anúncio Prêmios</span></a>
</li>

<li class="{{ Request::is('anuncioTemaEstabelecimentos*') ? 'active' : '' }}">
    <a href="{!! route('anuncioTemaEstabelecimentos.index') !!}"><i class="fa fa-edit"></i><span>Anúncio Tema Estabelecimentos</span></a>
</li>

<li class="{{ Request::is('anuncioVideos*') ? 'active' : '' }}">
    <a href="{!! route('anuncioVideos.index') !!}"><i class="fa fa-edit"></i><span>Anúncio Vídeos</span></a>
</li>
...
<li class="{{ Request::is('consumidors*') ? 'active' : '' }}">
    <a href="{!! route('consumidors.index') !!}"><i class="fa fa-edit"></i><span>Consumidores</span></a>
</li>


<li class="{{ Request::is('consumidorHistoricos*') ? 'active' : '' }}">
    <a href="{!! route('consumidorHistoricos.index') !!}"><i class="fa fa-edit"></i><span>Consumidor Históricos</span></a>
</li>

<li class="{{ Request::is('consumidorOpcaoCulinarias*') ? 'active' : '' }}">
    <a href="{!! route('consumidorOpcaoCulinarias.index') !!}"><i class="fa fa-edit"></i><span>Consumidor Opção Culinárias</span></a>
</li>
...
<li class="{{ Request::is('statusConsumidors*') ? 'active' : '' }}">
    <a href="{!! route('statusConsumidors.index') !!}"><i class="fa fa-edit"></i><span>Status Consumidor</span></a>
</li>
...
<li class="{{ Request::is('eventoHistoricos*') ? 'active' : '' }}">
    <a href="{!! route('eventoHistoricos.index') !!}"><i class="fa fa-edit"></i><span>Evento Históricos</span></a>
</li>
...
<li class="{{ Request::is('eventoPublicoAlvos*') ? 'active' : '' }}">
    <a href="{!! route('eventoPublicoAlvos.index') !!}"><i class="fa fa-edit"></i><span>Evento Público Alvos</span></a>
</li>

<li class="{{ Request::is('eventoServicos*') ? 'active' : '' }}">
    <a href="{!! route('eventoServicos.index') !!}"><i class="fa fa-edit"></i><span>Evento Serviços</span></a>
</li>

<li class="{{ Request::is('paginaEventos*') ? 'active' : '' }}">
    <a href="{!! route('paginaEventos.index') !!}"><i class="fa fa-edit"></i><span>Página Eventos</span></a>
</li>

<li class="{{ Request::is('paginaEventoFotos*') ? 'active' : '' }}">
    <a href="{!! route('paginaEventoFotos.index') !!}"><i class="fa fa-edit"></i><span>Página Evento Fotos</span></a>
</li>

<li class="{{ Request::is('paginaEventoPosts*') ? 'active' : '' }}">
    <a href="{!! route('paginaEventoPosts.index') !!}"><i class="fa fa-edit"></i><span>Página Evento Posts</span></a>
</li>

<li class="{{ Request::is('paginaEventoRecados*') ? 'active' : '' }}">
    <a href="{!! route('paginaEventoRecados.index') !!}"><i class="fa fa-edit"></i><span>Página Evento Recados</span></a>
</li>

<li class="{{ Request::is('paginaEventoVideos*') ? 'active' : '' }}">
    <a href="{!! route('paginaEventoVideos.index') !!}"><i class="fa fa-edit"></i><span>Página Evento Vídeos</span></a>
</li>
...
<li class="{{ Request::is('orcamentos*') ? 'active' : '' }}">
    <a href="{!! route('orcamentos.index') !!}"><i class="fa fa-edit"></i><span>Orçamentos</span></a>
</li>

<li class="{{ Request::is('orcamentoAvulsos*') ? 'active' : '' }}">
    <a href="{!! route('orcamentoAvulsos.index') !!}"><i class="fa fa-edit"></i><span>Orçamentos Avulsos</span></a>
</li>

<li class="{{ Request::is('orcamentoItems*') ? 'active' : '' }}">
    <a href="{!! route('orcamentoItems.index') !!}"><i class="fa fa-edit"></i><span>Orçamentos Items</span></a>
</li>

<li class="{{ Request::is('orcamentoMensagens*') ? 'active' : '' }}">
    <a href="{!! route('orcamentoMensagens.index') !!}"><i class="fa fa-edit"></i><span>Orçamentos Mensagens</span></a>
</li>

<li class="{{ Request::is('statusOrcamentos*') ? 'active' : '' }}">
    <a href="{!! route('statusOrcamentos.index') !!}"><i class="fa fa-edit"></i><span>Status Orçamentos</span></a>
</li>
...
<li class="{{ Request::is('grauServicos*') ? 'active' : '' }}">
    <a href="{!! route('grauServicos.index') !!}"><i class="fa fa-edit"></i><span>Grau Serviços</span></a>
</li>

<li class="{{ Request::is('opcaoCulinarias*') ? 'active' : '' }}">
    <a href="{!! route('opcaoCulinarias.index') !!}"><i class="fa fa-edit"></i><span>Opção Culinárias</span></a>
</li>
...
<li class="{{ Request::is('preferenciaSaidas*') ? 'active' : '' }}">
    <a href="{!! route('preferenciaSaidas.index') !!}"><i class="fa fa-edit"></i><span>Preferência Saídas</span></a>
</li>

<li class="{{ Request::is('ramoNegocios*') ? 'active' : '' }}">
    <a href="{!! route('ramoNegocios.index') !!}"><i class="fa fa-edit"></i><span>Ramo Negócios</span></a>
</li>
