 ...
 */
class OpcaoCulinaria extends Model
{
    use SoftDeletes;

    public $table = 'opcaoculinaria';
    ...
    {
        return $this->belongsToMany(\App\Models\Consumidor::class, 'consumidoropcaoculinaria');
    }
}
